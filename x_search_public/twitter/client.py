...
Usage (from repo root):
  python -m x_search_public.twitter.client user elonmusk
  python -m x_search_public.twitter.client me
  python -m x_search_public.twitter.client search "from:xai" --max 10
  python -m x_search_public.twitter.client post "Hello from grokbot"
"""
