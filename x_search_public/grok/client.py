...
Usage (from repo root):
  python -m x_search_public.grok.client text "Your prompt"
  python -m x_search_public.grok.client image "A collage of London landmarks..."
  python -m x_search_public.grok.client video "A glowing crystal-powered rocket..."
  python -m x_search_public.grok.client tts "Hello!" --voice eve -o hello.mp3
"""
