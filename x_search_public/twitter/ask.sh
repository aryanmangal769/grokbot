...
#
#   ./x_search_public/twitter/ask.sh user elonmusk
#   ./x_search_public/twitter/ask.sh me
#   ./x_search_public/twitter/ask.sh search "from:xai"
#   ./x_search_public/twitter/ask.sh post "Hello from grokbot"
...
cmd_me() {
  ...
  python3 -m x_search_public.twitter.client me
}
...
cmd_post() {
  ...
  python3 -m x_search_public.twitter.client post "$text"
}

usage() {
  cat <<'EOF'
Usage:
  ./x_search_public/twitter/ask.sh user <username>     # Bearer read
  ./x_search_public/twitter/ask.sh me                  # OAuth 1.0a (Python)
  ./x_search_public/twitter/ask.sh search <query>      # Bearer read
  ./x_search_public/twitter/ask.sh post <text>         # OAuth 1.0a (Python)
